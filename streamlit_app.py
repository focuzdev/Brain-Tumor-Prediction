...
""", unsafe_allow_html=True)
    ...
    with st.spinner("Running CNN inference..."):
        ...
        if model:
            ...
            # actually loaded, has PASSED a sanity check, and is averaged.
            # `ensemble_mode` is surfaced to the UI, the sidebar, and the
            # Claude report prompt so none of them overstate what the
            # running system actually did.
