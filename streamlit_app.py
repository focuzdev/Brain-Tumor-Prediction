...
/* ══════════════════════════════════════════════════
   CUSTOM PROPERTIES  —  dark defaults (root)
   Override block below sets light values on body.light
   ══════════════════════════════════════════════════ */
:root {
  --bg:          #04090f;
...
body.light {
  ...
  --txt:         #0a1628;           /* near-black — primary body text */
  --txt-m:       #2d4a6b;           /* dark navy — secondary text, fully readable */
  --txt-d:       #4a6580;           /* medium slate — captions, labels */
  ...
  --slbl:        #0e6b8a;           /* teal — section labels */
  --slbl-ln:     #9ecadb;
  --rb-bg:       #ffffff;
  --rb-txt:      #0a1628;           /* full-contrast report body */
  --rb-ttl:      #2d4a6b;           /* readable label above report text */
  --rb-red-bg:   #fde8e8;
  --rb-yel-bg:   #fef3cd;
  --rb-grn-bg:   #d8f5e8;
  --disc-bg:     #fef6d8;
  --disc-bdr:    #d4a017;
  --disc-txt:    #7a4800;           /* deep amber — readable on yellow bg */
  --hr:          #c2d8e8;
  --tab-bg:      #ddeef8;
  --tab-bdr:     #a8cfe0;
  --tab-col:     #1e3a55;           /* dark navy for unselected tabs */
  --met-bg:      #ffffff;
  --met-bdr:     #a8cfe0;
  --met-lbl:     #2d4a6b;
  --sel-bg:      #ffffff;
  ...
  --up-bg:       #d8eefb;
  --up-bdr:      #0e7490;
  --up-txt:      #084e65;           /* dark teal — readable on light blue */
  --code-bg:     #e8f4fb;
  --code-txt:    #0a4570;
  --code-bdr:    #a0c8dc;
  --img-bdr:     #a8cfe0;
  --pip-txt:     #2d4a6b;           /* pipeline step text — readable */
  --pip-str:     #0a1628;
  --pip-arr:     #4a8fa8;
  --hs-lbl:      #2d4a6b;           /* hero stat labels — readable */
  --hm-bg:       #f4faff;
  --hm-bdr:      #a0cce0;
  --hm-hdr:      #daeeff;
  --hm-hdr-b:    #a8cfe0;
  --hm-div:      #b8d8ec;
  --hm-sl:       #2d4a6b;           /* heatmap sub-labels */
  --hm-lbl:      #1a3550;           /* heatmap column labels — dark */
  --hm-note:     #2d4a6b;
  --hm-leg:      #1a3550;
  --hm-img-b:    #a8cfe0;
  --hm-ex-bg:    #ffffff;
  --hm-ex-bdr:   #a8cfe0;
  --hm-ex-b:     #0a1628;           /* explanation body — full contrast */
  --cs-bg:       #ffffff;
  --cs-lbl:      #2d4a6b;
  --pr-a:        #daeeff;
  --pr-b:        #cce5f8;
...
<script>
(function() {
  // Default is LIGHT. Apply saved preference before first paint — no flash.
  var saved = localStorage.getItem('neuroscan-theme');
  // If no saved pref, default to light; only skip if explicitly set to dark
  if (saved !== 'dark') {
  ...
  function wireToggle() {
    ...
    btn.addEventListener('click', function() {
      ...
      localStorage.setItem('neuroscan-theme', isLight ? 'light' : 'dark');
      // Swap the icon without any server round-trip
